        ...
        return (
          <div className="flex flex-col p-4 md:p-6 gap-6">
            {branchData.length > 0 ? (
                ...
                >
                  ...
                  <div className="w-full flex flex-col justify-between">
                    ...
                    <div className="mt-5">
                      <Link
                        target="-blank"
                        className="flex w-full md:w-2/4 xl:w-1/4 gap-2 items-center justify-center text-white bg-mainColor px-8
              ...
              <p className="text-center text-gray-500 text-lg">No branches available at the moment.</p>
            )}
          </div>
        );        
}
